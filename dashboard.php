...
$servername = "localhost"; // Ensure this matches your new database server
$username = "root";        // Update with your new database username
$password = "";            // Update with your new database password
$dbname = "login";         // Update with your new database name
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error); // Log error for debugging
}
...
//1. Mentorship Appointments
$fetch_appointments = true; // Flag to control fetching
if ($fetch_appointments) {  // Conditionally fetch if the flag is true
...
if ($fetch_events) {
    ...
    if ($stmt) { // Check if prepare() was successful
        ...
        // Log the exact SQL error and query
        die("Error preparing statement for registered events: " . $conn->error . " | Query: " . $query . " | Email: " . $user_email);
    }
}
...
//4. Job Applications
$fetch_job_applications = true;
if ($fetch_job_applications) {
    $user_email = $_SESSION["email"];
    ...
    if ($stmt) { // Check if prepare() was successful
        ...
        die("Error preparing statement for job applications: " . $conn->error); // Log error
    }
}

//5. Alumni Connections
$fetch_alumni_connections = true;
if ($fetch_alumni_connections) {
    $user_email = $_SESSION["email"];
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <style>
        ...
        .dropdown-menu {
            position: absolute;
            z-index: 20; /* Ensure dropdown menu is above the banner */
        }

        /* Lower z-index for the banner */
        .banner {
            position: relative;
            z-index: -1; /* Ensure banner is below dropdowns */
        }
    </style>
</head>
...
<div class="banner"><?php include 'banner.php'; ?></div>
    ...
    <div class="flex">
        <!-- Sidebar -->
        <aside class="w-72 bg-orange-400 text-black p-6 h-screen overflow-y-auto">
        ...
        <main class="flex-1 p-10 ml-10">
            ...
            <div class="relative z-10 w-full flex flex-col md:flex-row justify-between items-start">
                ...
                <div class="mt-6 flex justify-end">
                    <a href="change.php"
                    class="inline-flex items-center bg-yellow-400 text-gray-900 px-6 py-3 font-semibold rounded-lg shadow-md hover:bg-yellow-300 transition-all duration-300">
            ...
            <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Networking Hub -->
                <div class="bg-orange-100 text-black p-6 rounded-lg shadow-lg flex flex-col items-center">
                    <i class="fas fa-users text-5xl mb-4"></i>
                    <h2 class="text-xl font-bold">Networking Hub</h2>
                    <p class="mt-2 text-center">Connect with alumni in your industry.</p>
                    <a href="NetworkingHub.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">Explore</a>
                </div>
                ...
                <div class="bg-orange-100 text-black  p-6 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <a href="JobPortal.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">Explore</a>
                </div>
                ...
                <div class="bg-orange-100 text-black  p-6 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <a href="DonationPortal.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">Donate Now</a>
                </div>
                ...
                <div class="bg-orange-100 text-black  p-6 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <a href="EventsReunions.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">View Events</a>
                </div>
                ...
                <div class="bg-orange-100 text-black  p-6 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <a href="SuccessStories.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">Explore</a>
                </div>
                ...
                <div class="bg-orange-100 text-black  p-6 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <a href="feedback_form.php" class="block mt-4 bg-blue-600 text-white py-2 px-4 rounded text-center font-bold">Give Feedback</a>
                </div>
            </section>
        </main>
    </div>
